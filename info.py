...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5860228893').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002261121145'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001868871195'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002302078053'))  # Notification of those who verify will be sent to your channel
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://godlikeadi02:three@cluster3.5q9qt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002492785499'))  # Log channel id (make sure bot is admin)
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd6ba67f5ea7fd09b2402c2ef11ce88e8b9176053')
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/moviesupdateshere')
OWNERID = int(os.environ.get('OWNERID', '6077444526'))  # Replace with the actual admin ID
